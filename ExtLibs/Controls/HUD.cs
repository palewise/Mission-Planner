        ...
        protected override void OnLoad(EventArgs e)
        {
            if (opengl && !DesignMode)
            {
                try
                {
                    ...
                    log.Info("Vendor: " + OpenTK.Graphics.OpenGL.GL.GetString(OpenTK.Graphics.OpenGL.StringName.Vendor));
                    log.Info("Version: " + OpenTK.Graphics.OpenGL.GL.GetString(OpenTK.Graphics.OpenGL.StringName.Version));
                    log.Info("Device: " + OpenTK.Graphics.OpenGL.GL.GetString(OpenTK.Graphics.OpenGL.StringName.Renderer));
